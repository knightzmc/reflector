 ...
 * This annotation violates best practices of making beans and reflector-compatible classes,
 * and so should only be used as a workaround where exposing a getter isn't possible for some reason.
